...
/**
 * Dev preview client — renders the new Calendar Coach hero, day ribbon, and
 * trends disclosure with hard-coded mock data. No auth, no DB, no API.
 *
 * Mounted by ./page.tsx, which 404s this route in production builds.
 */
import {
  HeroNextSession,
  TodaysDocket,
